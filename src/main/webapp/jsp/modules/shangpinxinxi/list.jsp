...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="kouweiSearch" class="form-control form-control-sm" placeholder="请输入口味" aria-controls="tableId">
									<label>
										商品尺寸
									</label>
									<select name="shangpinchicun" id="shangpinchicunSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('kouwei')">口味<i id="kouweiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shangpinchicun')">商品尺寸<i id="shangpinchicunIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#kouweiSearch').val() != null && $('#kouweiSearch').val() != ''){
				searchForm.kouwei ="%" +  $('#kouweiSearch').val() + "%";
			}
			
			var shangpinchicunIndex = document.getElementById("shangpinchicunSelect").selectedIndex;
			var shangpinchicunOptions = document.getElementById("shangpinchicunSelect").options;
			var shangpinchicunSelectedOption = shangpinchicunOptions[shangpinchicunIndex]
			if(shangpinchicunSelectedOption.text != null && shangpinchicunSelectedOption.text != ''){
				searchForm.shangpinchicun = shangpinchicunSelectedOption.text;
			}
			getDataList();
		}		
		// 获取数据列表
        function getDataList() {
			http("shangpinxinxi/page","GET",{
				...
				kouwei : searchForm.kouwei,	
				shangpinchicun : searchForm.shangpinchicun,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var kouweiCell  = document.createElement('td');

						 kouweiCell.innerHTML = item.kouwei;

			row.appendChild(kouweiCell);
			var shangpinchicunCell  = document.createElement('td');

						 shangpinchicunCell.innerHTML = item.shangpinchicun;

			row.appendChild(shangpinchicunCell);
	...
	function shangpinchicunSelect(){
		//填充下拉框选项
		http("option/shangpinchicun/shangpinchicun","GET",{},(res)=>{
			if(res.code == 0){
				shangpinchicunOptions = res.data;
				var nullOption = document.createElement('option');
				var shangpinchicunSelect = document.getElementById('shangpinchicunSelect');
				shangpinchicunSelect.appendChild(nullOption);
				for(var i=0;i<shangpinchicunOptions.length;i++){
					var shangpinchicunOption = document.createElement('option');
					shangpinchicunOption.setAttribute('name','shangpinchicunOption');
					shangpinchicunOption.setAttribute('value',shangpinchicunOptions[i]);
					shangpinchicunOption.innerHTML = shangpinchicunOptions[i];
					shangpinchicunSelect.appendChild(shangpinchicunOption);
				}
			}
		});
	}
