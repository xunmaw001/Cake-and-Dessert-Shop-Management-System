...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>颜色</label>
										<input name="yanse" id="yanse" name="yanse" class="form-control" placeholder="颜色">
									</div>
									<div class="form-group col-md-6">
										<label>口味</label>
										<input name="kouwei" id="kouwei" name="kouwei" class="form-control" placeholder="口味">
									</div>
									<div class="form-group col-md-6">
										<label>商品尺寸</label>
										<select id="shangpinchicunSelect" name="shangpinchicun" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>价格</label>
	...
	<script>
			...
			http("option/shangpinchicun/shangpinchicun","GET",{},(res)=>{
				if(res.code == 0){
					...
					for(var i=0;i<shangpinchicunOptions.length;i++){
						...
						if(ruleForm.shangpinchicun == shangpinchicunOptions[i]){
							shangpinchicunOption.setAttribute('selected','selected');
						}
		...
		function dataBind(){
			...
			$("#kouwei").val(ruleForm.kouwei);	
			var shangpinchicunOptions = document.getElementsByClassName("shangpinchicunOption");
			for(var shangpinchicunCount = 0; shangpinchicunCount < shangpinchicunOptions.length;shangpinchicunCount++){
				if(shangpinchicunOptions[shangpinchicunCount].getAttribute('value') == ruleForm.shangpinchicun){
					shangpinchicunOptions[shangpinchicunCount].setAttribute('selected','selected');
				}
			}
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yanse != null && res.data.yanse != ''){
						...
						$("#yanse").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kouwei != null && res.data.kouwei != ''){

						$("#kouwei").val(res.data.kouwei);
						$("#kouwei").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.shangpinchicun != null && res.data.shangpinchicun != ''){

						var shangpinchicunOptions = document.getElementsByClassName("shangpinchicunOption");
						for(var shangpinchicunCount = 0; shangpinchicunCount < shangpinchicunOptions.length;shangpinchicunCount++){
							if(shangpinchicunOptions[shangpinchicunCount].getAttribute('value') == res.data.shangpinchicun){
								shangpinchicunOptions[shangpinchicunCount].setAttribute('selected','selected');
							}
						}
					}
